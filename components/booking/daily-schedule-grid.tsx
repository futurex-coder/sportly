...
export default function DailyScheduleGrid({
  ...
  // Filter fields client-side (sport + surface/env/lighting)
  const filteredFields = useMemo(() => {
    return schedule.filter((fs) => {
      if (sportCategoryId && fs.field.sportCategory?.id !== sportCategoryId) return false;
  ...
  }, [schedule, sportCategoryId, surfaceFilter, envFilter, lightFilter]);
